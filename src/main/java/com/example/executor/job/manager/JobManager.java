...
public class JobManager {
    ...
    private final String resultPath = System.getenv("RESULTS") != null ? System.getenv("RESULTS") : "/tmp";
    ...
    public void doJob(Job job) {
        executor.submit(() -> {
            ...
            jobDB.save(job);
            fakeWork();
            var byId = jobDB.findById(job.getId());
    ...
    private void finishJob(Job job, Job value) {
